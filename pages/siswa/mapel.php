...
<body>
  ...
  <main id="main">
	...
	if (!isset($_SESSION['user'])) {
        ...
        <?php
            $data_table = '';
			$data2 = getMapel($_SESSION['id']);
            foreach ($data2 as $key => $val) {
				$data_table .= '
				<tr>
				<td><center>'.$val['mapel'].'</center></td>
			...
			if ($data_table == "") {
				$data_table = '<tr class="table-danger"><th colspan="3"><center>NO DATA</center></th></tr>';
			}
	}else{
